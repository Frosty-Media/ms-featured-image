...
class Common {
    ...
    /**
     * Get's the cached transient key value.
     *
     * @param string $input
     *
     * @return string
     */
    public static function getTransientKey( string $input ) {
     ...
     * @return string
     */
    public static function getSiteFeaturedImage( $blog_id = '', $size = 'thumbnail', $image = true ): string {
        ...
        return isset( $image_attributes[0] ) ? $image_attributes[0] : '';
    }
