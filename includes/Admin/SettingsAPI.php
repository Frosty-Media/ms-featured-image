...
class SettingsAPI {
	...
	public function admin_enqueue_scripts( $hook ) {
		if ( FeaturedImage::get_settings_page_hook() !== $hook ) return;
	...
	private function get_the_image( $value ) {
		...
		if ( !empty( $image_id ) ) {
			$html = '<div class="alignleft">' . wp_get_attachment_image( $image_id, array( 50, 50 ) ) . '</div>';
		} else {
	...
	public function show_forms() {
		...
		$plugin_slug = FeaturedImage::get_plugin_slug(); ?>
