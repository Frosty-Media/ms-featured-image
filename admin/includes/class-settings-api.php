 ...
 */
class MS_Featured_Image_Settings_API {
    ...
    function admin_enqueue_scripts( $hook ) {
		if ( MS_Featured_Image::get_instance()->get_settings_page_hook() !== $hook )
			return;
    ...
    function callback_file( $args ) {
		...
		$image_id = !empty( $value ) ? url_to_attachmentid( $value ) : null;
		
		if ( !is_null( $image_id ) ) {
			// retrieve the thumbnail size of our image
			//$image_thumb = wp_get_attachment_image_src( $image_id, 'thumbnail' );
			
			$html .= '<div class="">' . wp_get_attachment_image( $image_id, array( 50,50 ) ) . '</div>';
		}
     ...
     */
    function show_forms() {
		$plugin_slug = MS_Featured_Image::get_instance()->get_plugin_slug();
        ?>
        <div class="metabox-holder">
            <div class="postbox">
                <?php foreach ( $this->settings_sections as $form ) { ?>
                    <div id="<?php echo $form['id']; ?>" class="group">
                        <form method="post" action="<?php echo esc_url( add_query_arg( array( 'page' => $plugin_slug, 'action' => 'ms-feat-img', '_msfi_nonce' => wp_create_nonce( 'ms-feat-img' ) ), network_admin_url( 'settings.php' ) ) ); ?>">

							<?php //wp_nonce_field( 'ms-feat-img' ); ?>
                            ...
                            <div style="padding-left: 10px">
                                <?php submit_button( '', '', $plugin_slug . '_submit' ); ?>
                            </div>
                        </form>
